                        ...
                        <div class="card-body card-block">
                            <form action="" method="post" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="hf-menu" name="hf-menu" placeholder="Edit category..." class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="hf-menu" name="hf-menu" placeholder="Edit menu..." class="form-control">
                                    </div>
                                </div>
                            </form>
                        </div>
